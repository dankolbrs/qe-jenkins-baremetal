...
def run_upgrade_return_results(release="master", host_ip="127.0.0.1"){
    ...
    upgrade_output = sh returnStdout: true, script: """
        ...
        wget https://gist.githubusercontent.com/dankolbrs/6224de079f4815838e6d2fb12943d083/raw/d9043e572613578a2c04ce9514c52a8a96b24802/ansible-role-requirements.yml -O /opt/openstack-ansible/ansible-role-requirements.yml
        ######################
        # End cheat
        ######################
        export TERM=xterm
